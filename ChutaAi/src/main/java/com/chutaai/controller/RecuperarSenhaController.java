...
import com.chutaai.util.PasswordUtil; // IMPORTANTE: Trazendo a sua ferramenta oficial de senha
...
public class RecuperarSenhaController implements Serializable {
    ...
    public void recuperarSenha() {
        ...
        try {
            ...
            // CRIPTOGRAFA A SENHA USANDO A SUA FERRAMENTA OFICIAL DO SISTEMA
            String senhaCriptografada = PasswordUtil.hash(novaSenha);
