...
public class PalpiteController implements Serializable {
    ...
    public void irParaPalpite(Partida partida) {
        try {
            ...
            System.out.println(">>> REDIRECIONAMENTO ACIONADO! Jogo: " + partida.getTimeCasa());
    ...
    public String salvarPalpite() {
        ...
        try {
            ...
            FacesContext.getCurrentInstance().addMessage(null,
                    new FacesMessage(FacesMessage.SEVERITY_INFO, "Sucesso!", "O seu palpite foi registrado."));
    ...
    // O NOSSO EXORCISMO DO BUG DE TELA VELHA ESTÁ AQUI:
    public List<Palpite> getMeusPalpites() {
